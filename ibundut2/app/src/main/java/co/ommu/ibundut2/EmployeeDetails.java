...
public class EmployeeDetails extends ListActivity {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		menu.add(0, MENU_NEW_CONTACT, 0, "New Contact").setIcon(R.mipmap.add);
		menu.add(0, MENU_ATTACH_CONTACT, 1, "Attach Contact").setIcon(R.mipmap.add);
		menu.add(0, MENU_EDIT_CONTACT, 2, "Edit Contact").setIcon(R.mipmap.edit);
		menu.add(0, MENU_REMOVE_CONTACT, 3, "Remove Contact").setIcon(R.mipmap.delete);
		menu.add(0, MENU_HELP, 4, "Help").setIcon(R.mipmap.help);
	    return true;
	}
